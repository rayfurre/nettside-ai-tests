...
// VERSION: 7.2 (v7.0 base + betalingstest steg 13)
// ===================================================
...
test.describe('Nettside.ai - Komplett test', () => {
  ...
  test('Registrering, generering, kladd, editor og betaling', async ({ page, context }) => {
    ...
    try {
      ...
      if (!progressStartet) { await page.screenshot({ path: 'test-results/steg4-ingen-progress.png' }).catch(() => {}); result.screenshots.push('steg4-ingen-progress.png'); }
    } catch (error) {
    ...
    try {
      ...
      await page.screenshot({ path: `test-results/${sn}`, fullPage: true }).catch(() => {}); result.screenshots.push(sn);
    } catch (error) {
      await page.screenshot({ path: 'test-results/steg5-feil.png', fullPage: true }).catch(() => {}); result.screenshots.push('steg5-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg6-feil.png' }).catch(() => {}); result.screenshots.push('steg6-feil.png');
    ...
    try {
      ...
      while (!result.kladdUrl && urlElapsed < maxUrlWait) {
        ...
        if (!result.kladdUrl) {
          for (const link of await page.locator('a[href*="draft"]').all()) {
      ...
      if (result.kladdUrl) {
        ...
        await page.screenshot({ path: 'test-results/steg7-ingen-url.png' }).catch(() => {}); result.screenshots.push('steg7-ingen-url.png');
      ...
      await page.screenshot({ path: 'test-results/steg7-feil.png' }).catch(() => {}); result.screenshots.push('steg7-feil.png');
    ...
    // ================================================================
    // EDITOR-TESTER (steg 9-12) — identisk med v7.0
    // ================================================================
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg9a-redigeringsmodus.png' }).catch(() => {}); result.screenshots.push('steg9a-redigeringsmodus.png');
      ...
      await page.screenshot({ path: 'test-results/steg9a-feil.png' }).catch(() => {}); result.screenshots.push('steg9a-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg9b-tekst-endret.png' }).catch(() => {}); result.screenshots.push('steg9b-tekst-endret.png');
      result.steg.push({ navn: 'Steg 9b: Endre overskrift', status: 'OK', melding: `Tekst: "${testTekst}"`, tidBrukt: Date.now() - stegStart });
    } catch (error) {
      await page.screenshot({ path: 'test-results/steg9b-feil.png' }).catch(() => {}); result.screenshots.push('steg9b-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg9c-lagret.png' }).catch(() => {}); result.screenshots.push('steg9c-lagret.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg10a-feil.png' }).catch(() => {}); result.screenshots.push('steg10a-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg10b-modal.png' }).catch(() => {}); result.screenshots.push('steg10b-modal.png');
      result.steg.push({ navn: 'Steg 10b: Åpne bilde-modal', status: 'OK', melding: 'Modal åpnet', tidBrukt: Date.now() - stegStart });
    } catch (error) {
      await page.screenshot({ path: 'test-results/steg10b-feil.png' }).catch(() => {}); result.screenshots.push('steg10b-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg10c-opplastet.png' }).catch(() => {}); result.screenshots.push('steg10c-opplastet.png');
      result.steg.push({ navn: 'Steg 10c: Last opp bilde', status: 'OK', melding: 'Testbilde lastet opp', tidBrukt: Date.now() - stegStart });
    } catch (error) {
      await page.screenshot({ path: 'test-results/steg10c-feil.png' }).catch(() => {}); result.screenshots.push('steg10c-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg10d-feil.png' }).catch(() => {}); result.screenshots.push('steg10d-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg11a-feil.png' }).catch(() => {}); result.screenshots.push('steg11a-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg11b-feil.png' }).catch(() => {}); result.screenshots.push('steg11b-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg11c-feil.png' }).catch(() => {}); result.screenshots.push('steg11c-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg11d-feil.png' }).catch(() => {}); result.screenshots.push('steg11d-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg12a-feil.png' }).catch(() => {}); result.screenshots.push('steg12a-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg12b-feil.png' }).catch(() => {}); result.screenshots.push('steg12b-feil.png');
    ...
    try {
      ...
      while (!ready && elapsed < 30000) { const v = await promptInput.inputValue().catch(() => ''); if (v.length > 10) { ready = true; console.log(`   ✅ AI-beskrivelse: "${v.substring(0,60)}..."`); break; } await page.waitForTimeout(2000); elapsed += 2000; }
      await page.screenshot({ path: 'test-results/steg12c-ai-beskrivelse.png' }).catch(() => {}); result.screenshots.push('steg12c-ai-beskrivelse.png');
      ...
      await page.screenshot({ path: 'test-results/steg12c-feil.png' }).catch(() => {}); result.screenshots.push('steg12c-feil.png');
    ...
    try {
      ...
      while (!done && elapsed < 15000) { await page.waitForTimeout(2000); elapsed += 2000; const a = await page.locator(SEL.aiPromptInput).inputValue().catch(() => ''); if (a !== before && a.length > 10) { done = true; console.log(`   ✅ Forbedret: "${a.substring(0,60)}..."`); } }
      await page.screenshot({ path: 'test-results/steg12d-forbedret.png' }).catch(() => {}); result.screenshots.push('steg12d-forbedret.png');
      ...
      await page.screenshot({ path: 'test-results/steg12d-feil.png' }).catch(() => {}); result.screenshots.push('steg12d-feil.png');
    ...
    try {
      ...
      let elapsed = 0; let done = false;
      while (!done && elapsed < 90000) { await page.waitForTimeout(3000); elapsed += 3000; await collectToasts(page, logs);
      ...
      await page.screenshot({ path: 'test-results/steg12e-ai-bilde.png' }).catch(() => {}); result.screenshots.push('steg12e-ai-bilde.png');
      result.steg.push({ navn: 'Steg 12e: Generer med AI', status: done ? 'OK' : 'FEILET', melding: done ? `Generert etter ${Math.round(elapsed/1000)}s` : 'Timeout etter 90s', tidBrukt: Date.now() - stegStart });
    } catch (error) {
      await page.screenshot({ path: 'test-results/steg12e-feil.png' }).catch(() => {}); result.screenshots.push('steg12e-feil.png');
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg12f-feil.png' }).catch(() => {}); result.screenshots.push('steg12f-feil.png');
    ...
    try {
      const saved = await saveEditorChanges(page); await collectToasts(page, logs);
      await page.screenshot({ path: 'test-results/steg12g-lagret.png' }).catch(() => {}); result.screenshots.push('steg12g-lagret.png');
    ...
    // ================================================================
    //
    //  BETALINGSTEST (steg 13) — NYTT i v7.2
    //  Bruker klikker Publiser → pristabellen → Velg Pro → Stripe
    //  Vi verifiserer at Stripe checkout laster, IKKE at betaling utføres.
    //
    // ================================================================

    // Lukk eventuelle åpne dialoger og gå tilbake til normalvisning
    await page.keyboard.press('Escape').catch(() => {});
    await page.waitForTimeout(1000);

    // Sørg for at vi er ute av redigeringsmodus
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg13a-publiser-klikket.png' }).catch(() => {});
      ...
      await page.screenshot({ path: 'test-results/steg13a-feil.png' }).catch(() => {});
    ...
    try {
      ...
      await page.screenshot({ path: 'test-results/steg13b-pristabellen.png' }).catch(() => {});
      ...
      await page.screenshot({ path: 'test-results/steg13b-feil.png' }).catch(() => {});
    ...
    try {
      ...
      // Lytt etter ny fane/popup som åpnes
      ...
      await page.screenshot({ path: 'test-results/steg13c-etter-klikk.png' }).catch(() => {});
      ...
      try {
        ...
        const pageContent = await stripePage.content();
        ...
        await stripePage.screenshot({ path: 'test-results/steg13d-feil.png' }).catch(() => {});
      ...
      await page.screenshot({ path: 'test-results/steg13c-feil.png' }).catch(() => {});
